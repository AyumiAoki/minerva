...
class ConteudoPortuguesActivity : AppCompatActivity(), View.OnClickListener {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        val nomeMateria = "Linguagem"

        val reference = FirebaseDatabase.getInstance().reference
        val m : DatabaseReference = reference.child("usuarios").child(FirebaseAuth.getInstance().currentUser!!.uid).child("materias").child("Portugues")
        var qntdRevisado = ""
        var subtitulo = ""
        ...
        setContentView(R.layout.activity_conteudo_portugues)
