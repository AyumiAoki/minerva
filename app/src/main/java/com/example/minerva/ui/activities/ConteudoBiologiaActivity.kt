...
class ConteudoBiologiaActivity : AppCompatActivity(), View.OnClickListener {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        val nomeMateria = "Biologia"

        val reference = FirebaseDatabase.getInstance().reference
        val m : DatabaseReference = reference.child("usuarios").child(FirebaseAuth.getInstance().currentUser!!.uid).child("materias").child("Biologia")
        var qntdRevisado = ""
        var subtitulo = ""
        ...
        setContentView(R.layout.activity_conteudo_biologia)
